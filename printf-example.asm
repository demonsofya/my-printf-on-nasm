...
_my_printf: 
    ...
    end_program:
        ...
        pop rbp                 ; àäðåñ âîçâðàòà ñîõðàíÿåì ó ñåáÿ
...
char_printf_arg:
        ...
        mov bl, 'c'             ; ñì îïèñàíèå ïîäîáíîãî â %s
...
string_printf_arg:
    ...
    .continue_cycle:
        ...
        mov bl, 's'             ; áëÿ íó òàì êîðî÷å îíî ïðûãàåò íà ïðîâåðêó òîãî, ÷òî ó ìåíÿ ñòðîêà íå êîíè÷èëàñü, à îíà êîí÷èëàñü åñëè òóò 0 ëåæèò ïîýòîìó íàäî ÷åò äðóãîå çàïèõíóòü äà ýòî êîñòûëü
        jmp write_one_symbol
